        ...
        this.items = {
            ...
            items : [{
                ...
                items : [{
                    ...
                    trackOver : true,
                    tpl : ['<table><tbody><tr><tpl for=".">', '<td>', '<div class="template-wrap"><div class="base_type">{base_type}</div>', '<div class="template-icon-wrap" data-qtip="{tooltip_name}">', '<span>{name_short}</span>', '<img src="resources/img/appicons/{name_short}.png" width="65" height="65" onerror="this.style.display =\'none\'"/>', '</div></div><div class="template_name">{display_name}</div></td>', '</tpl></tbody></table>', ''],
