Ext.define('Onc.view.tabs.SystemTab', {
    ...
    initComponent : function() {
        ...
        this.items = [rec.isPhysical() ? null : {
            ...
            items : [Ext.widget('computestatecontrol', {
                ...
                items : {
                    ...
                    scale : 'large',
                    icon : 'resources/img/icon/zabbix.png',
                    iconAlign : 'top',
            ...
            items : [{
                ...
                html : rec.get('cpu_info')
            }, {
                html : 'Memory'
            }, {
                style : "font-weight: bold",
                html : rec.get('memory') + 'MB'
            }, {
                html : 'Swap'
            }, {
                style : "font-weight: bold",
                html : rec.get('swap_size') + 'MB'
            }, {
                html : 'OS Release'
            }, {
                style : "font-weight: bold",
                html : rec.get('os_release')
            }, {
                html : 'Kernel'
            }, {
                style : "font-weight: bold",
        ...
        this._uptimeUpdateInterval = setInterval( function() {
            this.down('#uptime').update(rec.get('state') === 'active' ? rec.getUptime() : 'Server is switched off.');
        }.bind(this), 1000);
