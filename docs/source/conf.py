# -*- coding: utf-8 -*-
#
# ONC documentation build configuration file, created by
...
latex_documents = [
  ('index', 'ONC.tex', u'ONC Documentation',
...
texinfo_documents = [
  ('index', 'ONC', u'ONC Documentation',
   u'Opennode Ltd', 'ONC', 'One line description of project.',
   'Miscellaneous'),
]
